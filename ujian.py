...
def show_creator():
    creator_label = tk.Label(root, text='Nama : Abib Raifmuaffah Ihwan   | NIM : F55121043   | Kelas : B  | Jurusan : Teknologi Informasi | Prodi : Teknik Informatika | Fakultas : Teknik ')
